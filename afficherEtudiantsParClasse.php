...
$query = "SELECT DISTINCT groupe FROM groupeetudiant ORDER BY groupe ASC";
...
<input type="hidden" name="hidden_groupe" id="hidden_groupe" />
<div class="col-sm-12">
...
$(document).ready(function(){
 ...
 $('#classe').change(function(){
  $('#hidden_groupe').val($('#classe').val());
  var query = $('#hidden_groupe').val();
  load_data(query);
 });
