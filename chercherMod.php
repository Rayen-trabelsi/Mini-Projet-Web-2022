...
if(mysqli_num_rows($result)){
	while ($row=mysqli_fetch_assoc($result)) {
		echo '	<table><tr>
		          ...
		          <td>'.$row['email'].'</td>
				  <td>'.$row['Classe'].'</td>
		    	  <td><button><a href="modifieretudiantt.php?cin=<?php '.$cin.' ?>">Modifier</a></button></td>
		        </tr></table>';
	}
}
else{
...
foreach ($etudiants as $etudiant):
	echo'<table><tr>
		    	  ...
		    	  <td><button class="btn btn-primary" ><a class="text-light" href="modifieretudiantt.php?cin='.$etudiant['cin'].'">Modifier</a></button></td>
		        </tr></table>';
endforeach;
}
else{
