...
if (isset($_POST["envoyer"]))
{
    ...
    if ($resultat){
        echo "<br><h6 >Le groupe est modifié avec succés</h6>";
    }
    else{
...
if (isset($_POST["envoyer"]))
{
    ...
    $req2="UPDATE  `etudiant` set Classe='$nom1' WHERE Classe='$nom'";
    $resultat2=mysqli_query($conn,$req2);
    if ($resultat2){
        echo "<br><h6 >Les etudiants sont supprimés avec succés</h6><br>";
    }
    else{
        echo "<br><h6 >Un Erreur Est Survenu</h6><br>";
    }
