...
<main role="main">
  ...
  <div class="container">
    ...
    <div class="col-md-4">
        ...
        <button class="btn btn-secondary" type="submit" name="info1"><a href="afficherGroupeParNiveau.php? niveau=INFO1" class="text-light" > Voir les Groupes &raquo;</a></button>
      </div>
      <div class="col-md-4">
        <h2>INFO2</h2>
       
        <button class="btn btn-secondary" type="submit" name="info2"><a href="afficherGroupeParNiveau.php? niveau=INFO2" class="text-light" > Voir les Groupes &raquo;</a></button>
      </div>
      <div class="col-md-4">
        <h2>INFO3</h2>
        
        <button class="btn btn-secondary" type="submit" name="info3"><a href="afficherGroupeParNiveau.php? niveau=INFO3" class="text-light" > Voir les Groupes &raquo;</a></button>
      </div>
    </div>
